                ...
                case 0:
                    switch (currentCommand)
                    {
                        ...
                        case SDCardCommand.SET_USB_MODE:
                            if (isPresent)
                            {
                                data[0] = (byte)SDCardResponse.CMD_RET_SUCCESS;
                            }
                            else
                            {
                                data[0] = (byte)SDCardResponse.CMD_RET_ABORT;
                            }
                            break;
                        ...
                        case SDCardCommand.BYTE_READ:
                            ...
                            else
                            {
                                ...
                                data[0] = (byte)SDCardInterrupt.USB_INT_DISK_READ;
                                byteRead++;
                            }
                            break;
                    }
            ...
            else
            {
                ...
                if (slf != null)
                {
                    ...
                    else
                    {
                        ...
                        data[0] = (byte)SDCardResponse.CMD_STAT_SUCCESS;
                    }
                }
            }
        }
