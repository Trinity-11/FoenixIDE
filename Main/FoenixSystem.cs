        ...
        public FoenixSystem(BoardVersion version, string DefaultKernel)
        {
            ...
            if (!BoardVersionHelpers.IsF256(boardVersion))
            {
                ...
                MemMgr = new MemoryManager
                {
                    ...
                    DMA = vdma,
                    TIMER0 = new TimerRegister(MemoryMap.TIMER0_CTRL_REG, 8, 14318000),
                    TIMER1 = new TimerRegister(MemoryMap.TIMER1_CTRL_REG, 8, 14318000),
                    TIMER2 = new TimerRegister(MemoryMap.TIMER2_CTRL_REG, 8, 14318000),
            ...
            else
            {
                ...
                if (BoardVersionHelpers.IsF256_Flat(boardVersion))
                {
                    ...
                    MemMgr = new MemoryManagerF256Flat
                    {
                        ...
                        DMA = dma,
                        TIMER0 = new TimerRegister(MemoryMap.TIMER0_CTRL_REG_F256_FLAT, 8, 14318000),
                        TIMER1 = new TimerRegister(MemoryMap.TIMER1_CTRL_REG_F256_FLAT, 8, 60),
                ...
                else
                {
                    ...
                    MemMgr = new MemoryManagerF256
                    {
                        ...
                        DMA = dma,
                        TIMER0 = new TimerRegister(MemoryMap.TIMER0_CTRL_REG_F256_MMU, 8, 14318000),
                        TIMER1 = new TimerRegister(MemoryMap.TIMER1_CTRL_REG_F256_MMU, 8, 60),
